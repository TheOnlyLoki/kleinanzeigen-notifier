...
watches:
  - name: "BMW E46"
    query: "BMW E46"
    location: "82297"       # PLZ or place name
...
- **`/add`** - guided, step-by-step: asks for name, keywords, location,
  radius, price range, and check interval, then starts watching immediately
